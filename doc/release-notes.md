Machinecoin Core version 0.16.3 is now available from:

  <https://machinecoincore.org/bin/machinecoin-core-0.16.3/>
...
Machinecoin Core versions 0.14.0 up to 0.16.2. It is recommended to upgrade any of
...
### Miscellaneous
- #13655 `1cdbea7` machinecoinconsensus: invalid flags error should be set to `machinecoinconsensus_err` (afk11)
